    ...
    <div className="-mx-6">
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-3xl mx-auto space-y-10 text-kt-text-secondary leading-relaxed">
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">1. Acceptance of Terms</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">2. Eligibility</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">3. Account Registration</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">4. Free Credits and Bonuses</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">5. Deposits and Withdrawals</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">6. AI Trading and Returns</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">7. Referral Program</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">8. Prohibited Activities</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">9. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">10. Governing Law</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-kt-text-primary mb-3">11. Contact</h2>
