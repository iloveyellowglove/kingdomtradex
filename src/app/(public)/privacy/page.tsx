    ...
    <div className="-mx-6">
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="max-w-3xl mx-auto space-y-10 text-text-secondary leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-bold text-text-primary mb-3">3. Data Storage and Security</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-text-primary mb-3">7. Communications</h2>
