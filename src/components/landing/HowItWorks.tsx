export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-16 lg:py-20" style={{ background: '#0B0E11' }}>
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-[22px] sm:text-[28px] font-semibold text-[#EAECEF] mb-2">How It Works</h2>
          <p className="text-sm text-[#848E9C]">Three simple steps to start earning daily</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[900px] mx-auto">
          {steps.map((s, i) => (
            <div key={s.num} className="relative text-center p-8 rounded-xl" style={{ background: '#1E2329', border: '1px solid #2B3139' }}>
              ...
              {i < steps.length - 1 && (
                <div className="hidden md:block absolute top-1/2 -right-4 w-8 border-t border-dashed border-[#2B3139]" />
              )}
              ...
              <h3 className="text-lg font-semibold text-[#EAECEF] mb-2">{s.title}</h3>
