...
export default function RegisterForm({ csrfToken }: { csrfToken: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="username" className="block text-kt-text-secondary font-medium mb-1">Username</label>
      ...
      <div>
        <label htmlFor="referral" className="block text-kt-text-secondary font-medium mb-1">Referral Code (optional)</label>
